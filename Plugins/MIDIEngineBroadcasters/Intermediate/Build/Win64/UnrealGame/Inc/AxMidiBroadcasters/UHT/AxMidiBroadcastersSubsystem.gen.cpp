...
void FAxMidiCurveDelegate_DelegateWrapper(const FMulticastScriptDelegate& AxMidiCurveDelegate, float CurveValue, UAxMidiPlayhead* PlayHead, const TScriptInterface<IAxMidiBroadcaster>& Broadcaster)
{
	...
	UAxMidiBroadcastersSubsystem::~UAxMidiBroadcastersSubsystem() {}
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_3245118562(TEXT("/Script/AxMidiBroadcasters"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
