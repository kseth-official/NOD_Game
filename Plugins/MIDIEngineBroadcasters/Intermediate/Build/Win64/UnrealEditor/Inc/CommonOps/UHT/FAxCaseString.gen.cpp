...
template<> COMMONOPS_API UScriptStruct* StaticStruct<FAxCaseString>()
{
	...
	struct Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_CommonOps_Public_Strings_FAxCaseString_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_CommonOps_Public_Strings_FAxCaseString_h_Statics::ScriptStructInfo[] = {
		{ FAxCaseString::StaticStruct, Z_Construct_UScriptStruct_FAxCaseString_Statics::NewStructOps, TEXT("AxCaseString"), &Z_Registration_Info_UScriptStruct_AxCaseString, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAxCaseString), 2311755999U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_CommonOps_Public_Strings_FAxCaseString_h_1696939290(TEXT("/Script/CommonOps"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_CommonOps_Public_Strings_FAxCaseString_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_CommonOps_Public_Strings_FAxCaseString_h_Statics::ScriptStructInfo),
		nullptr, 0);
