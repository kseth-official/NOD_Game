...
void FAxMidiNoteDelegate_DelegateWrapper(const FMulticastScriptDelegate& AxMidiNoteDelegate, const FString& TrackName, UAxMidiNote* MidiNote, UAxMidiPlayhead* PlayHead, const TScriptInterface<IAxMidiBroadcaster>& Broadcaster)
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_AxMidiBroadcasters_AxMidiChordDelegate__DelegateSignature_Statics::NewProp_MidiChord = { "MidiChord", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_AxMidiBroadcasters_eventAxMidiChordDelegate_Parms, MidiChord), Z_Construct_UScriptStruct_FAxMidiChord, METADATA_PARAMS(0, nullptr) }; // 3267800944
...
void FAxMidiCurveDelegate_DelegateWrapper(const FMulticastScriptDelegate& AxMidiCurveDelegate, float CurveValue, UAxMidiPlayhead* PlayHead, const TScriptInterface<IAxMidiBroadcaster>& Broadcaster)
{
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAxMidiBroadcastersSubsystem_Statics::NewProp_ChordOnEventsDelegate = { "ChordOnEventsDelegate", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAxMidiBroadcastersSubsystem, ChordOnEventsDelegate), Z_Construct_UDelegateFunction_AxMidiBroadcasters_AxMidiChordDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAxMidiBroadcastersSubsystem_Statics::NewProp_ChordOnEventsDelegate_MetaData), Z_Construct_UClass_UAxMidiBroadcastersSubsystem_Statics::NewProp_ChordOnEventsDelegate_MetaData) }; // 35574317
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAxMidiBroadcastersSubsystem_Statics::NewProp_NoteOffEventsDelegate = { "NoteOffEventsDelegate", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAxMidiBroadcastersSubsystem, NoteOffEventsDelegate), Z_Construct_UDelegateFunction_AxMidiBroadcasters_AxMidiNoteDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAxMidiBroadcastersSubsystem_Statics::NewProp_NoteOffEventsDelegate_MetaData), Z_Construct_UClass_UAxMidiBroadcastersSubsystem_Statics::NewProp_NoteOffEventsDelegate_MetaData) }; // 3398577548
#if WITH_METADATA
	...
	UAxMidiBroadcastersSubsystem::~UAxMidiBroadcastersSubsystem() {}
	struct Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAxMidiBroadcastersSubsystem, UAxMidiBroadcastersSubsystem::StaticClass, TEXT("UAxMidiBroadcastersSubsystem"), &Z_Registration_Info_UClass_UAxMidiBroadcastersSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAxMidiBroadcastersSubsystem), 9937241U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_1232226385(TEXT("/Script/AxMidiBroadcasters"),
		Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Subsystems_AxMidiBroadcastersSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
