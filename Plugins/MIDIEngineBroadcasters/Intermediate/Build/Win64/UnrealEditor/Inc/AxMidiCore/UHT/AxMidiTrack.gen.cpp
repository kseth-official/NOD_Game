...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAxMidiTrack_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAxMidiTrack_GetMidiNotesAsArray, "GetMidiNotesAsArray" }, // 3980939925
	};
	...
	struct Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiTrack_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAxMidiPitchRow, UAxMidiPitchRow::StaticClass, TEXT("UAxMidiPitchRow"), &Z_Registration_Info_UClass_UAxMidiPitchRow, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAxMidiPitchRow), 2037948424U) },
		{ Z_Construct_UClass_UAxMidiTrack, UAxMidiTrack::StaticClass, TEXT("UAxMidiTrack"), &Z_Registration_Info_UClass_UAxMidiTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAxMidiTrack), 2729926305U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiTrack_h_482960885(TEXT("/Script/AxMidiCore"),
		Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiTrack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiTrack_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
