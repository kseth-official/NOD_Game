...
template<> AXMIDICORE_API UScriptStruct* StaticStruct<FAxMidiChord>()
{
	...
	struct Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_Statics::EnumInfo[] = {
		...
		{ EAxMidiChordStructure_StaticEnum, TEXT("EAxMidiChordStructure"), &Z_Registration_Info_UEnum_EAxMidiChordStructure, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2680570293U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_Statics::ScriptStructInfo[] = {
		{ FAxMidiChord::StaticStruct, Z_Construct_UScriptStruct_FAxMidiChord_Statics::NewStructOps, TEXT("AxMidiChord"), &Z_Registration_Info_UScriptStruct_AxMidiChord, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAxMidiChord), 3267800944U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_4289573940(TEXT("/Script/AxMidiCore"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ue5_projects_Team13_Game_Plugins_MIDIEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiChord_h_Statics::EnumInfo));
