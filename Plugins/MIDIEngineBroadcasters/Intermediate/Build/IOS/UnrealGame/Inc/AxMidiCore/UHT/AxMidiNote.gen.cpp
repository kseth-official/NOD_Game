...
template<> AXMIDICORE_API UScriptStruct* StaticStruct<FAxMidiNoteProperties>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAxMidiNote_GetMidiNoteProperties_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AxMidiNote_eventGetMidiNoteProperties_Parms, ReturnValue), Z_Construct_UScriptStruct_FAxMidiNoteProperties, METADATA_PARAMS(0, nullptr) }; // 1781206308
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAxMidiNote_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAxMidiNote_GetAdjustedDuration, "GetAdjustedDuration" }, // 2543594769
		{ &Z_Construct_UFunction_UAxMidiNote_GetAdjustedStartTime, "GetAdjustedStartTime" }, // 3553118305
		{ &Z_Construct_UFunction_UAxMidiNote_GetAdjustedStopTime, "GetAdjustedStopTime" }, // 2116674125
		{ &Z_Construct_UFunction_UAxMidiNote_GetMidiAssetObject, "GetMidiAssetObject" }, // 2428861998
		{ &Z_Construct_UFunction_UAxMidiNote_GetMidiNoteProperties, "GetMidiNoteProperties" }, // 2054067088
		{ &Z_Construct_UFunction_UAxMidiNote_GetMidiTrackName, "GetMidiTrackName" }, // 2418784262
		{ &Z_Construct_UFunction_UAxMidiNote_GetMidiTrackObject, "GetMidiTrackObject" }, // 1280319984
		{ &Z_Construct_UFunction_UAxMidiNote_GetPitch, "GetPitch" }, // 1612335391
		{ &Z_Construct_UFunction_UAxMidiNote_GetPitchName, "GetPitchName" }, // 805232079
	};
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_Statics::ScriptStructInfo[] = {
		{ FAxMidiNoteProperties::StaticStruct, Z_Construct_UScriptStruct_FAxMidiNoteProperties_Statics::NewStructOps, TEXT("AxMidiNoteProperties"), &Z_Registration_Info_UScriptStruct_AxMidiNoteProperties, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAxMidiNoteProperties), 1781206308U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAxMidiNote, UAxMidiNote::StaticClass, TEXT("UAxMidiNote"), &Z_Registration_Info_UClass_UAxMidiNote, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAxMidiNote), 751742222U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_3220182006(TEXT("/Script/AxMidiCore"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiCore_Public_MidiClasses_AxMidiNote_h_Statics::ScriptStructInfo),
		nullptr, 0);
