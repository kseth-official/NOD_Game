...
void FAxOnMidiSectionEvent_DelegateWrapper(const FMulticastScriptDelegate& AxOnMidiSectionEvent, UAxMidiTimelinePlayhead* MidiPlayhead)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAxMidiTimelinePlayhead_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAxMidiTimelinePlayhead_OnTimelineSectionFinished, "OnTimelineSectionFinished" }, // 2557281884
	};
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Playheads_AxMidiTimelinePlayhead_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Playheads_AxMidiTimelinePlayhead_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAxMidiTimelinePlayhead, UAxMidiTimelinePlayhead::StaticClass, TEXT("UAxMidiTimelinePlayhead"), &Z_Registration_Info_UClass_UAxMidiTimelinePlayhead, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAxMidiTimelinePlayhead), 2654912452U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Playheads_AxMidiTimelinePlayhead_h_1005455971(TEXT("/Script/AxMidiBroadcasters"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Playheads_AxMidiTimelinePlayhead_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_MidiEngineBroadcasters_Source_Runtime_AxMidiBroadcasters_Public_Playheads_AxMidiTimelinePlayhead_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
